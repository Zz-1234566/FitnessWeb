...
const UpdatePassword: React.FC = () => {
  ...
  return (
    <div className="auth-container">
      <Helmet>
        <title>修改密码 - {document.title}</title>
      </Helmet>
      ...
      <div className="auth-left" onMouseMove={handleMouseMove}>
        ...
        <div className="auth-fitness-icon auth-fi-1" style={parallax(2.2)}><SafetyCertificateOutlined /></div>
        <div className="auth-fitness-icon auth-fi-2" style={parallax(-1.6)}><LockOutlined /></div>
        <div className="auth-fitness-icon auth-fi-3" style={parallax(1.8)}><HeartOutlined /></div>

        <div className="auth-left-content">
          <div className="auth-brand-logo">
            <img src={SYSTEM_LOGO} alt="Tatan" />
          </div>
          <h1 className="auth-brand-title">安全设置</h1>
          <p className="auth-brand-subtitle">保护你的账号安全</p>
